...
public class BarrierSDK extends HCSDK {
    ...
    public static void addToWhiteNameList(String deviceName, String licensePlateNumber, LocalDateTime startTime, LocalDateTime endTime) throws InstructionExecuteException {
        ...
        synchronized (lock) {
            ...
            if (!bSend) {
                throw new InstructionExecuteException("调用NET_DVR_SendRemoteConfig下发车牌时异常，错误码：" + hcNetSDK.NET_DVR_GetLastError(),1);
            }
        }
        //关闭连接，释放资源
    ...
    public static void deleteFromWhiteNameList(String deviceName, String licensePlateNumber) throws InstructionExecuteException {
        ...
        synchronized (lock) {
            ...
            if (!b) {
                throw new InstructionExecuteException("调用NET_DVR_RemoteControl删除车牌时异常，错误码：" + hcNetSDK.NET_DVR_GetLastError(),1);
            }
        }
