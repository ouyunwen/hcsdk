...
//NET_DVR_Login()参数结构
    ...
    */
    ...
    //交通事件报警(扩展)
    class NET_DVR_AID_ALARM_V41 extends Structure {
        public int dwSize;              //结构长度
        public int dwRelativeTime;        //相对时标
        public int dwAbsTime;            //绝对时标
        public NET_VCA_DEV_INFO struDevInfo = new NET_VCA_DEV_INFO();            //前端设备信息
    ...
    //交通统计信息报警(扩展)
    class NET_DVR_TPS_ALARM_V41 extends Structure {
        public int dwSize;          // 结构体大小
        public int dwRelativeTime;  // 相对时标
        public int dwAbsTime;       // 绝对时标
    ...
    class NET_DVR_LANE_PARAM_V41 extends Structure {
    ...
    class NET_DVR_TPS_INFO_V41 extends Structure {
    ...
    // 车道队列结构体
    class NET_DVR_LANE_QUEUE extends Structure {
    ...
    //TPS统计过车数据上传
    class NET_DVR_TPS_STATISTICS_INFO extends Structure {
        public int dwSize;          // 结构体大小
    ...
    // 交通参数统计信息
    class NET_DVR_TPS_STATISTICS_PARAM extends Structure {
    ...
    //统计信息
    class NET_DVR_TPS_LANE_PARAM extends Structure {
...
//2007-11-30 V211支持以下接口 //11
    ...
    class NET_DVR_VEHICLE_CONTROL_DELINFO extends Structure {
        public int dwSize;
        public int dwDelType;//删除条件类型，删除条件类型，参照VCA_OPERATE_TYPE。（可复选）
        public byte[] sLicense = new byte[16]; //车牌号码
        public byte[] sCardNo = new byte[48]; // 卡号
        public byte byPlateType;    //车牌类型
